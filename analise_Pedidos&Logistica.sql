...
-- ============================================================
-- AN�LISE DE PEDIDOS E LOG�STICA
-- ============================================================
...
-- ============================================================
-- Nota m�dia: pedidos atrasados vs no prazo
-- ============================================================
SELECT 
    CASE 
...
-- ============================================================
-- Tempo m�dio de entrega por estado (em dias)
-- ============================================================
SELECT 
    c.customer_state,
...
-- ============================================================
-- Classifica��o dos pedidos pelo prazo de entrega:
-- ============================================================
WITH Entregas AS (
	SELECT
		 order_id AS Pedidos,
		 CASE
			WHEN order_delivered_customer_date IS NULL THEN 'N�o entregue'
...
-- ============================================================
-- Pedidos cujo o valor est� acima da m�dia 
-- do pr�prio estado do cliente.
-- ============================================================
SELECT 
