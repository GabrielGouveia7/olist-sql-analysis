...
-- ============================================================
-- Top 10 Estados com maior n�mero de clientes
-- ============================================================
SELECT TOP 10
	customer_state, 
...
-- ============================================================
-- �ndice de recompra (clientes com mais de 1 pedido)
-- ============================================================
...
-- ============================================================
-- Nota m�dia e percentual de notas negativas
-- ============================================================
...
rfm_scores AS (
    SELECT 
        ...
        NTILE(5) OVER (ORDER BY recencia     ASC)  AS r_score, -- menor rec�ncia = melhor
...
SELECT 
    ...
    CASE 
        WHEN (r_score + f_score + m_score) >= 13 THEN 'Campe�o'
