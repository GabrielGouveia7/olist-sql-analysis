...
-- ============================================================
-- AN�LISE DE CATEGORIA E VENDEDORES
-- ============================================================
...
-- ============================================================
-- Classifica��o dos vendedores baseado no faturamento total
-- ============================================================
...
SELECT 
    ...
    CASE 
        ...
        WHEN Faturamento_total < 100000 THEN 'M�dio'
        ELSE 'Alto'
...
WHERE total_pedidos >= 50  -- foco em vendedores com volume relevante
